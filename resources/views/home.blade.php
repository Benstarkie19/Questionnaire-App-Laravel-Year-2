...
<div class="col mb-4">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="questionnaire/create">Start Questionnaire</a>  <!-- drop down menu for the  questionaire and the admin    -->
    <a class="dropdown-item" href="questionnaire">Admin</a>
  </div>
</div>
    </div>
  </div>
...
<div class="col mb-4">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="degree.html">See Your Anwsers/Results</a>  <!-- drop down menu for the  questionaire and the admin    -->
